const submitBtn = document.querySelector(".submit-btn"), phone = document.querySelector("#phone"), password = document.querySelector("#user-password"), passwordConfirm = document.querySelector("#user-password-confirm"), email = document.querySelector("#mail"), errorDisplayers = document.getElementsByClassName("error"), inputFields = document.querySelectorAll("input"), cardContainer = document.querySelector(".card-container"), outroOverlay = document.querySelector(".outro-overlay");
let count = 2;
...
submitBtn.addEventListener("click", (e)=>{
    ...
    } else for(let i = 0; i < errorDisplayers.length; i++)errorDisplayers[i].textContent = "*This field is Required";
});

//# sourceMappingURL=index.c178ebb3.js.map
